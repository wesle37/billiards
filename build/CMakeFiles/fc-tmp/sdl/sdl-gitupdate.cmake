...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "release-3.4.0"
  WORKING_DIRECTORY "/home/wesle/projects/billiards/build/_deps/sdl-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/wesle/projects/billiards/build/_deps/sdl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/wesle/projects/billiards/build/_deps/sdl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
